									...
									<div className="space-y-4">
										{session.events.map((event) => (
											<div key={event.eventId} className="relative flex gap-4">
												<div className="shrink-0 w-12 h-12 rounded-full bg-[#004747]/10 flex items-center justify-center text-2xl z-10">
