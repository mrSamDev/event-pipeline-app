    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-lg text-red-600">
          Error: {error instanceof Error ? error.message : 'Failed to load user journey'}
        </div>
      </div>
    );
  }
                  ...
                  <div className="space-y-4">
                    {session.events.map((event) => (
                      <div key={event.eventId} className="relative flex gap-4">
                        <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#004747]/10 flex items-center justify-center text-2xl z-10">
